      ...
      Opt (
        Seq [
          Alt [|
            ...
            Token (Name "semgrep_typed_metavariable");
          |];
          Repeat (
            Seq [
              Token (Literal ",");
              ...
              (fun v ->
                ...
                | Seq [v0; v1] ->
                    (
                      ...
                      | Alt (5, v) ->
                          `Semg_typed_meta (
                            trans_semgrep_typed_metavariable (Run.matcher_token v)
                          )
                      | _ -> assert false
                      )
                      ,
...
and trans_semgrep_typed_metavariable ((kind, body) : mt) : CST.semgrep_typed_metavariable =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2] ->
