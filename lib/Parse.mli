...
(**
    Functions for parsing python programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a python program from a string into a typed OCaml CST.
...
val string :
  ...
  (CST.module_, CST.extra) Tree_sitter_run.Parsing_result.t

(** Parse a python program from a file into a typed OCaml CST.
